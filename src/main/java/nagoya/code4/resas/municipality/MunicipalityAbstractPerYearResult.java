...
public abstract class MunicipalityAbstractPerYearResult extends AbstractResultList<MunicipalityPerYearResultData> {
	...
	public MunicipalityAbstractPerYearResult() {
		super();
	}
